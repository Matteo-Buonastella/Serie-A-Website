<!DOCTYPE html>
    <html>
        <head>
            ...
            ?>
            <link rel = "shortcut icon" href = "../images/Sassuolo.png"/>
            <link rel="stylesheet" href="../css/Theme.css"/>
            <link rel="stylesheet" href="../css/Sassuolo.css"/>
     ...
     <div class = "Info">
        <h2 class = "TeamName"> Sassuolo </h2>
        <section class = "position" id = "position">
                <script> Position(17); </script>
        </section>
        <section class = "form" id = "form">         <!-- Current Form function call -->
                <script> Form(17); </script>
        </section>
        <h4 class = "name">  Mapei Stadium </h4>
            <img src = "../images/Jersey/Sassuolo_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "13%">
            <img src = "../images/Jersey/Sassuolo_Away.png" class = "Jersey2" alt = "Jersey" height = "30%" width = "13%">

            <img src = "../images/Sassuolo.png" class = "Sassuolo" alt = "Sassuolo" height = "20%" width = "10%">
            
            <img src = "../images/Stadiums/SassuoloStadium.jpg"  class = "Stadium" alt = "SassuoloStadium" width = "29%">
           <h5 class = "opened"> Opened: 1995 &nbsp; &nbsp;    
               <span>   Capacity: 23,717 &nbsp; &nbsp;</span>
               <span>Owned: <span class="glyphicon glyphicon-ok"></span></span> </h5>

        <section class = "nextTeam" id = "nextTeam">  <!-- Next Match -->
                <script> NextMatch(17); </script>
        </section>
    </div>
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(17);" class = "Schedule"> Schedule </button>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [23, 21, 17, 12, 6, 12]   //League position
            }]
        },
        options:{
        title: {
