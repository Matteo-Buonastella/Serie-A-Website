<!DOCTYPE html>
    <html>
        <head>
            ...
            ?>
            <link rel = "shortcut icon" href = "../images/Udinese.png"/>
            <link rel="stylesheet" href="../css/Theme.css"/>
            <link rel="stylesheet" href="../css/Udinese.css"/>
    ...
    <div class = "Info">
        <h2 class = "TeamName"> Udinese </h2>
        <section class = "position" id = "position">
                <script> Position(20); </script>
        </section>
        <section class = "form" id = "form">         <!-- Current Form function call -->
                <script> Form(20); </script>
        </section>
        <h4 class = "name">  Dacia Arena</h4>
            <img src = "../images/Jersey/Udinese_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "13%">
            <img src = "../images/Jersey/Udinese_Away.png" class = "Jersey2" alt = "Jersey" height = "30%" width = "14%">

            <img src = "../images/Udinese.png" class = "Udinese" alt = "Udinese" height = "20%" width = "10%">
            
            <img src = "../images/Stadiums/UdineseStadium.jpg"  class = "Stadium" alt = "UdineseStadium" width = "31%">
           <h5 class = "opened"> Opened: 1976 (2015) &nbsp; &nbsp;    
               <span>   Capacity: 25,144 &nbsp; &nbsp;</span>
               <span>Owned: <span class="glyphicon glyphicon-ok"></span></span> </h5>

        <section class = "nextTeam" id = "nextTeam">  <!-- Next Match -->
                <script> NextMatch(20); </script>
        </section>
    </div>
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(20);" class = "Schedule"> Schedule </button>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [3, 5, 13, 16, 17, 13]   //League position
            }]
        },
        options:{
        title: {
