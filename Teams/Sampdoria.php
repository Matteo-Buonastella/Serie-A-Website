<!DOCTYPE html>
    <html>
        <head>
            ...
            ?>
            <link rel = "shortcut icon" href = "../images/Sampdoria.png"/>
            <link rel="stylesheet" href="../css/Theme.css"/>
            <link rel="stylesheet" href="../css/Sampdoria.css"/>
     ...
     <div class = "Info">
        <h2 class = "TeamName"> Sampdoria</h2>
        <section class = "position" id = "position">
                <script> Position(16); </script>
        </section>
        <section class = "form" id = "form">         <!-- Current Form function call -->
                <script> Form(16); </script>
        </section>
        <h4 class = "name"> Stadio Luigi Ferraris </h4>
            <img src = "../images/Jersey/Sampdoria_Home.jpg" class = "Jersey" alt = "Jersey" height = "30%" width = "12%">
            <img src = "../images/Jersey/Sampdoria_Away.jpg" class = "Jersey2" alt = "Jersey" height = "30%" width = "12%">

            <img src = "../images/Sampdoria.png" class = "Sampdoria" alt = "Samp" height = "20%" width = "10%">
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(16);" class = "Schedule"> Schedule </button>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [26, 14, 12, 7, 15, 10]   //League position
            }]
        },
        options:{
        title: {
