<!DOCTYPE html>
    <html>
        <head>
            ...
            ?>
            <link rel = "shortcut icon" href = "../images/Bologna.png"/>
            <link rel="stylesheet" href="../css/Theme.css"/>
            <link rel="stylesheet" href="../css/Bologna.css"/>
    ...
    <div class = "Info">
        <h2 class = "TeamName"> Bologna </h2>
        <section class = "position" id = "position">
                <script> Position(4); </script>
        </section>
        <section class = "form" id = "form">
                <script> Form(4); </script>
        </section>
        <h4 class = "name"> Stadio Renato Dall'Ara </h4>
            <img src = "../images/Jersey/Bologna_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "10%">
            <img src = "../images/Jersey/Bologna_Away.png" class = "Jersey2" alt = "Jersey" height = "30%" width = "9.6%">

            <img src = "../images/Bologna.png" class = "Bologna" alt = "Bologna" height = "20%" width = "7.5%">
            
            <img src = "../images/Stadiums/BolognaStadium.jpg"  class = "Stadium" alt = "BolognaStadium" width = "32%">
           <h5 class = "opened"> Opened: 1927 &nbsp; &nbsp;    
               <span>   Capacity: 38,279 &nbsp; &nbsp;</span>
               <span>Owned: <span class="glyphicon glyphicon-remove"></span></span> </h5>

        <section class = "nextTeam" id = "nextTeam">  <!-- Next Match -->
                <script> NextMatch(4); </script>
        </section>
    </div>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [9, 13, 19, 24, 14, 15]   //League position
            }]
        },
        options:{
        title: {
