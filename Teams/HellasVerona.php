<!DOCTYPE html>
    <html>
        <head>
            ...
            ?>
            <link rel = "shortcut icon" href = "../images/HellasVerona.png"/>
            <link rel="stylesheet" href="../css/Theme.css"/>
            <link rel="stylesheet" href="../css/HellasVerona.css"/>
     ...
     <div class = "Info">
        <h2 class = "TeamName"> Hellas Verona </h2>
        <section class = "position" id = "position">
                <script> Position(11); </script>
        </section>
        <section class = "form" id = "form">
                <script> Form(11); </script>
        </section>
        <h4 class = "name">  Stadio Marc'Antonio Bentegodi</h4>
            <img src = "../images/Jersey/HellasVerona_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "13%">
            <img src = "../images/Jersey/HellasVerona_Away.png" class = "Jersey2" alt = "Jersey" height = "30%" width = "13%">

            <img src = "../images/HellasVerona.png" class = "Verona" alt = "Verona" height = "20%" width = "9%">
            
            <img src = "../images/Stadiums/ChievoStadium.jpg"  class = "Stadium" alt = "BeneventoStadium" width = "30%">
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(11);" class = "Schedule"> Schedule </button>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [24, 22, 10, 13, 20, 22]   //League position
            }]
        },
        options:{
        title: {
