<!DOCTYPE html>
    <html>
        <head>
            ...
            ?>
            <link rel = "shortcut icon" href = "../images/Genoa.png"/>
            <link rel="stylesheet" href="../css/Theme.css"/>
            <link rel="stylesheet" href="../css/Genoa.css"/>
 ...
 <div class = "Info">
        <h2 class = "TeamName"> Genoa</h2>
        <section class = "position" id = "position">       <!-- Current Position -->
                <script> Position(10); </script>
        </section>
        <section class = "form" id = "form">               <!-- Current Form -->
                <script> Form(10); </script>
        </section>
        
        <h4 class = "name"> Stadio Luigi Ferraris </h4>
            <img src = "../images/Jersey/Genoa_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "10%">
            <img src = "../images/Jersey/Genoa_Away.gif" class = "Jersey2" alt = "Jersey" height = "30%" width = "13%">

            <img src = "../images/Genoa.png" class = "Genoa" alt = "Genoa" height = "20%" width = "10%">
            
            <img src = "../images/Stadiums/GenoaStadium.jpg"  class = "Stadium" alt = "GenoaStadium" width = "31%">
           <h5 class = "opened"> Opened: 1911 &nbsp; &nbsp;    
               <span>   Capacity: 36,599 &nbsp; &nbsp;</span>
               <span>Owned: <span class="glyphicon glyphicon-remove"></span></span> </h5>

        <section class = "nextTeam" id = "nextTeam">  <!-- Next Match -->
                <script> NextMatch(10); </script>
        </section>
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(10);" class = "Schedule"> Schedule </button>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [17, 17, 14, 6, 11, 16]   //League position
            }]
        },
        options:{
        title: {
