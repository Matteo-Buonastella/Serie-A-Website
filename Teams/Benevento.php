<!DOCTYPE html>
    <html>
        <head>
            ...
            ?>
            <link rel = "shortcut icon" href = "../images/Benevento.png"/>
            <link rel="stylesheet" href="../css/Theme.css"/>
            <link rel="stylesheet" href="../css/Benevento.css"/>
     ...
     <div class = "Info">
        <h2 class = "TeamName"> Benevento </h2>
        <section class = "position" id = "position">
                <script> Position(5); </script>
        </section>
        <section class = "form" id = "form">
                <script> Form(5); </script>
        </section>
        <h4 class = "name">  Stadio Ciro Vigorito</h4>
            <img src = "../images/Jersey/Benevento_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "12.5%">
            <img src = "../images/Jersey/Benevento_Away.png" class = "Jersey2" alt = "Jersey" height = "30%" width = "13%">

            <img src = "../images/Benevento.png" class = "Benevento" alt = "Benevento" height = "20%" width = "12%">
            
            <img src = "../images/Stadiums/BeneventoStadium.jpg"  class = "Stadium" alt = "BeneventoStadium" width = "29%">
           <h5 class = "opened"> Opened: 1979 &nbsp; &nbsp;    
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(5);" class = "Schedule"> Schedule </button>
...
<div id = "News">
    ...
    <div id = "Article" class = "Article">
       <h2> Bologna cruise past Benevento </h2>
        ...
        <button  class="btn btn-info"  onclick = "Benevento1()">Read More</button>
        <div id = "Benevento1" class = "display">
            <div id = "Beneventochoose1"></div>
        </div>
    </div>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [100, 100, 100, 100, 100, 25]   //League position
            }]
        },
        options:{
        title: {
