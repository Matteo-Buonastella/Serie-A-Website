<!DOCTYPE html>
    ...
    <div class = "Info">
        <h2 class = "TeamName"> Internazionale </h2>
        <section class = "position" id = "position">
                <script> Position(12); </script>
        </section>
        <section class = "form" id = "form">
                <script> Form(12); </script>
        </section>
        <h4 class = "name"> Giuseppe Meazza </h4>
            <img src = "../images/Jersey/Inter_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "13%">
            <img src = "../images/Jersey/Inter_Away.jpg" class = "Jersey2" alt = "Jersey" height = "30%" width = "13%">

            <img src = "../images/Inter.png" class = "Inter "alt = "Inter" height = "20%" width = "9%">
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(12);" class = "Schedule"> Schedule </button>
...
<div id = "News">
    ...
    <div id = "Article" class = "Article">
       <h2> Inter and Roma share the spoils </h2>
        ...
        <button  class="btn btn-info"  onclick = "Inter1()">Read More</button>
        <div id = "Inter1" class = "display">
            <div id = "Interchoose1"></div>
        </div>
    </div>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [6, 9, 5, 8, 4, 7]   //League position
            }]
        },
        options:{
        title: {
