<!DOCTYPE html>
    <html>
        <head>
            ...
            ?>
            <link rel = "shortcut icon" href = "../images/Fiorentina.png"/>
            <link rel="stylesheet" href="../css/Theme.css"/>
            <link rel="stylesheet" href="../css/Fiorentina.css"/>
 ...
 <div class = "Info">
        <h2 class = "TeamName"> Fiorentina</h2>
        <section class = "position" id = "position">
                <script> Position(9); </script>
        </section>
        <section class = "form" id = "form">
                <script> Form(9); </script>
        </section>
        <h4 class = "name"> Stadio Artemio Franchi </h4>
            <img src = "../images/Jersey/Fiorentina_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "9.5%">
            <img src = "../images/Jersey/Fiorentina_Away.png" class = "Jersey2" alt = "Jersey" height = "30%" width = "9.5%">

            <img src = "../images/Fiorentina.png" class = "Fiorentina" alt = "Fiorentina" height = "20%" width = "8%">
            
            <img src = "../images/Stadiums/FiorentinaStadium.jpg"  class = "Stadium" alt = "FiorentinaStadium" width = "30%">
           <h5 class = "opened"> Opened: 1931 &nbsp; &nbsp;    
               <span>   Capacity: 43,147 &nbsp; &nbsp;</span>
               <span>Owned: <span class="glyphicon glyphicon-remove"></span></span> </h5>

        <section class = "nextTeam" id = "nextTeam">  <!-- Next Match -->
                <script> NextMatch(9); </script>
        </section>
</div>
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(9);" class = "Schedule"> Schedule </button>
...
<div id = "News">
    ...
    <div id = "Article" class = "Article">
       <h2> Hellas Verona shock Fiorentina </h2>
        ...
        <button  class="btn btn-info"  onclick = "Fiorentina1()">Read More</button>
        <div id = "Fiorentina1" class = "display">
            <div id = "Fiorentinachoose1"></div>
        </div>
    </div>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [13, 4, 4, 4, 5, 8]   //League position
            }]
        },
        options:{
        title: {
