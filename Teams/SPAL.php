<!DOCTYPE html>
    <html>
        <head>
            ...
            ?>
            <link rel = "shortcut icon" href = "../images/SPAL.png"/>
            <link rel="stylesheet" href="../css/Theme.css"/>
            <link rel="stylesheet" href="../css/SPAL.css"/>
     ...
     <div class = "Info">
        <h2 class = "TeamName"> SPAL </h2>
        <section class = "position" id = "position">
                <script> Position(18); </script>
        </section>
        <section class = "form" id = "form">         <!-- Current Form function call -->
                <script> Form(18); </script>
        </section>
        <h4 class = "name">  Stadio Paolo Mazza</h4>
            <img src = "../images/Jersey/SPAL_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "14%">
            <img src = "../images/Jersey/SPAL_Away.png" class = "Jersey2" alt = "Jersey" height = "30%" width = "14%">

            <img src = "../images/SPAL.png" class = "SPAL" alt = "SPAL" height = "20%" width = "9%">
            
            <img src = "../images/Stadiums/SPALStadium.jpg"  class = "Stadium" alt = "SPALStadium" width = "29%">
           <h5 class = "opened"> Opened: 1928 &nbsp; &nbsp;    
               <span>   Capacity: 13,020 &nbsp; &nbsp;</span>
               <span>Owned: <span class="glyphicon glyphicon-remove"></span></span> </h5>

        <section class = "nextTeam" id = "nextTeam">  <!-- Next Match -->
                <script> NextMatch(18); </script>
        </section>
    </div>
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(18);" class = "Schedule"> Schedule </button>
...
<div id = "News">
    ...
    <div id = "Article" class = "Article">
       <h2> Udinise and SPAL settle for draw </h2>
        ...
        <button  class="btn btn-info"  onclick = "SPAL1()">Read More</button>
        <div id = "SPAL1" class = "display">
            <div id = "SPALchoose1"></div>
        </div>
    </div>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [99, 99, 99, 99, 99, 21]   //League position
            }]
        },
        options:{
        title: {
