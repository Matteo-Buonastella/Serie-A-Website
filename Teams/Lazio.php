<!DOCTYPE html>
    <html>
        <head>
            ...
            ?>
            <link rel = "shortcut icon" href = "../images/Lazio.png"/>
            <link rel="stylesheet" href="../css/Theme.css"/>
            <link rel="stylesheet" href="../css/Lazio.css"/>
    ...
    <div class = "Info">
        <h2 class = "TeamName"> Lazio</h2>
        <section class = "position" id = "position">
                <script> Position(14); </script>
        </section>
        <section class = "form" id = "form">         <!-- Current Form function call -->
                <script> Form(14); </script>
        </section>
        <h4 class = "name"> Stadio Olimpico </h4>
            <img src = "../images/Jersey/Lazio_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "14%">
            <img src = "../images/Jersey/Lazio_Away.png" class = "Jersey2" alt = "Jersey" height = "30%" width = "14%">

            <img src = "../images/Lazio.png" class = "Lazio" alt = "Lazio" height = "25%" width = "15%">
            
            <img src = "../images/Stadiums/StadioOlimpico.jpg"  class = "Stadium" alt = "GenoaStadium" width = "29%">
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(14);" class = "Schedule"> Schedule </button>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [4, 7, 9, 3, 8, 5]   //League position
            }]
        },
        options:{
        title: {
