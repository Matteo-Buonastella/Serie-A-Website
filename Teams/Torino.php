<!DOCTYPE html>
    <html>
     ...
     <div class = "Info">
        <h2 class = "TeamName"> Torino </h2>
        <section class = "position" id = "position">
                <script> Position(19); </script>
        </section>
        <section class = "form" id = "form">         <!-- Current Form function call -->
                <script> Form(19); </script>
        </section>
        <h4 class = "name"> Stadio Olimpico Grande Torino</h4>
            <img src = "../images/Jersey/Torino_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "13%">
            <img src = "../images/Jersey/Torino_Away.png" class = "Jersey2" alt = "Jersey" height = "30%" width = "13%">

            <img src = "../images/Torino.png" class = "Torino" alt = "Samp" height = "20%" width = "10%">
            
            <img src = "../images/Stadiums/TorinoStadium.jpg"  class = "Stadium" alt = "TorinoStadium" width = "30%">
           <h5 class = "opened"> Opened: 1933 &nbsp; &nbsp;    
               <span>   Capacity: 27,958 &nbsp; &nbsp;</span>
               <span>Owned: <span class="glyphicon glyphicon-remove"></span></span> </h5>

        <section class = "nextTeam" id = "nextTeam">  <!-- Next Match -->
                <script> NextMatch(19); </script>
        </section>
    </div>
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(19);" class = "Schedule"> Schedule </button>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [22, 16, 7, 9, 12, 9]   //League position
            }]
        },
        options:{
        title: {
