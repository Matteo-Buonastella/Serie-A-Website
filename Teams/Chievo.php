<!DOCTYPE html>
    <html>
        <head>
            ...
            ?>
            <link rel = "shortcut icon" href = "../images/Chievo.png"/>
            <link rel="stylesheet" href="../css/Theme.css"/>
            <link rel="stylesheet" href="../css/Chievo.css"/>
    ...
    <div class = "Info">
        <h2 class = "TeamName"> Chievo Verona </h2>
        <section class = "position" id = "position">
                <script> Position(7); </script>
        </section>
        <section class = "form" id = "form">
                <script> Form(7); </script>
        </section>
        <h4 class = "name"> Stadio Marc'Antonio Bentegodi </h4>
            <img src = "../images/Jersey/Chievo_Home.png" class = "Jersey" alt = "Jersey" height = "30%" width = "14%">
            <img src = "../images/Jersey/Chievo_Away.png" class = "Jersey2" alt = "Jersey" height = "30%" width = "12%">

            <img src = "../images/Chievo.png" class = "Chievo" alt = "Chievo" height = "20%" width = "10%">
            
            <img src = "../images/Stadiums/ChievoStadium.jpg"  class = "Stadium" alt = "ChievoStadium" width = "30%">
           <h5 class = "opened"> Opened: 1963 &nbsp; &nbsp;    
               <span>   Capacity: 39,371 &nbsp; &nbsp;</span>
               <span>Owned: <span class="glyphicon glyphicon-remove"></span></span> </h5>

        <section class = "nextTeam" id = "nextTeam">  <!-- Next Match -->
                <script> NextMatch(7); </script>
        </section>
    </div>
...
<div class = "TeamOption">
    ...
    <button onclick = "ClubSchedule(7);" class = "Schedule"> Schedule </button>
...
<div id = "News">
    ...
    <div id = "Article" class = "Article">
       <h2> Juventus beat 9 man Chievo </h2>
        ...
        <button  class="btn btn-info"  onclick = "Chievo2()">Read More</button>
        <div id = "Chievo2" class = "display">
            <div id = "Chievochoose2"></div>
        </div>
    </div>
    ...
    <div id = "Article" class = "Article">
       <h2> Lazio embarrass Chievo Verona </h2>
        ...
        <p><i>Matteo Buonastella</i>, January 21, 2018</p>
        <button  class="btn btn-info"  onclick = "Chievo1()">Read More</button>
        <div id = "Chievo1" class = "display">
            <div id = "Chievochoose1"></div>
        </div>
    </div>
    ...
    var historyChart = new Chart(myChart, {
        ...
        data:{
            ...
            datasets:[{
                ...
                borderColor: "black",
                borderCapStyle: 'butt',
                data: [10, 12, 16, 14, 9, 14]   //League position
            }]
        },
        options:{
        title: {
